...
### ✅ 痕跡逆算発掘法©️ v1.0
写真・メール・古い端末・作品サービス・人脈・契約など、現実に散った痕跡から本人情報を逆算する。記憶から無理に思い出さず、`痕跡 → 観測事実 → 派生推定 → 次の検索語 → 次の痕跡` と証拠チェーンを伸ばし、忘れていた過去・所有物・作品・人脈・権利・資産を発掘する。逆読みGoが会話内部の地層を掘るのに対し、こちらは外部証拠をまたいで進む。
...
### ✅ 往復線路法©️ v1.1
長いログを「記憶するもの」から「辿れるもの」へ変える。状態変化を駅として切り、前駅／この駅／次駅を双方向接続する。枝線・未回収駅も残し、逆読みで発掘したあと順読みで因果線を検品する。
